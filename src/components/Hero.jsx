...
const Hero = () => {
  ...
  return (
    ...
    className=" bg-slate-950 w-full h-screen overflow-hidden bg-center bg-contain bg-[url('https://github.githubassets.com/images/modules/site/home-campaign/bg-stars-1.webp')]">
      <div  className=' container mx-auto '>   
        <div className='px-5 mt-[180px] lg:mt-[250px] xl:mt-[200px] flex flex-col justify-center lg:flex-row lg:justify-evenly items-center'>
           {/* text */}
           <motion.div 
              ...
              <h1 className=' font-mono text-5xl lg:text-7xl xl:text-8xl mb-5 lg:mb-3 lg:text-left text-center md:text-center'>Hi,I'm Mahel</h1>
              <p className=' text-center lg:text-left text-2xl md:text-2xl lg:text-4xl text-yellow-400'><TypeAnimation
      sequence={[
      ...
      repeat={Infinity}
    /></p>
              <p className=' leading-loose text-md lg:text-xl text-gray-400 lg:w-[600px] lg:text-justify text-center lg:mt-3'>
           ...
           >
           <img  
               className='sm:w-[80%] md:w-[80%] lg:w-[100%] mx-auto h-auto animate-[updown_5s_ease-in-out_infinite]'
               src={Image}
               alt=""
            />
