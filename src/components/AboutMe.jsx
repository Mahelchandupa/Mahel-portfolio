              ...
              <div className='timeline-box flex-1 w-full '>
                <div className='timeline py-[30px] px-[15px] border-2 border-slate-300 w-full relative rounded-lg	'>
                  ...
                  <div className="timeline-item relative pl-[37px] pb-[20px] before:[''] before:w-[1px] before:absolute before:h-full before:left-[7px] before:top-0 before:bg-red-500">
                    ...
                    <p className=' mb-5 text-yellow-300 text-sm lg:text-md'>Ones & Zeros - Trainee Full Stack Developer</p>
                    <div>
                      <ul className='text-gray-400 text-sm lg:text-md'>
                        <li className=' mb-3'>Designed, developed, and maintained web applications using React for the front end and Spring Boot for the back end.</li>
                        <li className=' mb-3'>Utilized Material UI to create responsive, user-friendly interfaces, ensuring a seamless user experience.</li>
                        <li className=' mb-3'>Worked closely with cross-functional teams, including designers, product managers, and other developers, to gather requirements, create specifications, and deliver projects on time.</li>
                        <li className=' mb-3'>Participated in code reviews, wrote unit tests, and performed debugging to ensure high-quality code and software performance.</li>
                        <li className=' mb-3'>Managed code repositories and version control using Git, ensuring consistent project documentation and team collaboration.</li>
                        <li className=' mb-3'>Actively participated in Agile development processes, including daily stand-ups, sprint planning, and retrospectives.</li>
                        <li className=' mb-3'>Identified and resolved performance bottlenecks, bugs, and other issues, enhancing application efficiency and user satisfaction.</li>
                      </ul>
                    </div>
